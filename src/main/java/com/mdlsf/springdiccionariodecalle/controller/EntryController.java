...
//    public ResponseEntity<List<Entry>> getEntriesByInitial(@PathVariable String initial){
...
//            if (entry.getTerm().charAt(0) == initial.charAt(0)) {
//                list.add(entry);
//            }
//        }
//
...
//    }
//
//    private List<String> getAllTermsStartingWithCharacter(String character){
//        return entryRepository.getDictionariesByEntryNameIsStartingWith(character); //IT'S NOT CASE SENSITIVE
//    }
